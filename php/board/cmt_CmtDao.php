<?php 
	class CmtDao{
		...
		public function getCmsg($num){
			try{
				$sql = "select * from cmt num where num = :num";
		...
		public function getNumCmsgs($bdnum){
			try{
				$sql = "select count(*) from cmt where bdnum =:bdnum";
		...
		public function selectCmt($bdnum){
			try{
				$sql = "select * from cmt where bdnum =:bdnum order by num desc";
		...
		public function insertCmsg($id, $name, $bdnum, $cmt){
			try{
				$sql = "insert into cmt(id, name, bdnum, cmt) values(:id, :name, :bdnum, :cmt)";
		...
		public function deleteCmsg($num){
			try{
				$sql = "delete from cmt where num=:num";
		...
		public function updateCmt($num, $id, $name, $bdnum, $cmt){
			try{
				$sql = "update cmt set id=:id, name=:name, bdnum=:bdnum, cmt=:cmt where num=:num";
